...
LAMBDAS = email-import email-get email-query email-set mailbox-get mailbox-set thread-get email-changes mailbox-changes thread-changes blob-delete mailbox-cleanup email-cleanup account-init email-index searchsnippet-get
